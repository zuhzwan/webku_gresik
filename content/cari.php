...
<div class="hal_artikel">
    <h2>Hasil Pencarian : <?php echo $search; ?></h2>
    <div class="kanan">
        ...
        $query=mysql_query("SELECT A.id_berita, 
                ...
                WHERE A.judul LIKE '%$search%' ORDER BY A.id_berita DESC");
    ...
    <div class="artikel">
        ...
        <p><?php echo $isi2; ?> ...</p>
        <a class="selengkapnya" href='index.php?page=detailberita&hal=<?php echo $id_berita ;?>'>Selengkapnya</a>
